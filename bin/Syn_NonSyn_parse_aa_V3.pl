#!/usr/bin/perl -w
# usage perl Syn_NonSyn_parse_aa_V3 OR using Xiaofeng's perl /home/xiaofeng/sources/perl_5.32.1/bin/perl Syn_NonSyn_parse_aa_V3
open (INDEX, "/home/hannahg/projects/P323L/scv2-029+027/DiversiTools/loading_list.tsv");
@indexs=<INDEX>;
chomp @indexs;
close INDEX;
...
%hash=();
open(DATA,"/home/hannahg/projects/P323L/scv2-029+027/DiversiTools/$index\_aa_details.txt");
while (<DATA>) {
    chomp;
    @each=split(/\t/);
...
open(AA, "/home/hannahg/projects/P323L/scv2-029+027/DiversiTools/$index\_AA.txt");
while (<AA>) {
    unless (/^Sample\tChr/) {
        @eachindex=split(/\t/);
        $Chr=$eachindex[1];
